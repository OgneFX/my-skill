...
val TOP_TYPES = mapOf(
    FilmCategories.BEST to "TOP_250_BEST_FILMS",
    FilmCategories.POPULAR to "TOP_100_POPULAR_FILMS",
    FilmCategories.AWAIT to "TOP_AWAIT_FILMS",
    FilmCategories.TV_SERIES to "TV_SERIES",
    FilmCategories.PREMIERS to "PREMIERES"
)
